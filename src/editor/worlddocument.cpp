    ...
    , mUndoRedo(this)
{
    ...
    connect(&mUndoRedo, qOverload<PropertyHolder*,int>(&WorldDocumentUndoRedo::templateRemoved),
            this, qOverload<PropertyHolder*,int>(&WorldDocument::templateRemoved));
    ...
    connect(&mUndoRedo, &WorldDocumentUndoRedo::roadAdded,
            this, &WorldDocument::roadAdded);
    connect(&mUndoRedo, &WorldDocumentUndoRedo::roadAboutToBeRemoved,
            this, &WorldDocument::roadAboutToBeRemoved);
    connect(&mUndoRedo, &WorldDocumentUndoRedo::roadRemoved,
            this, &WorldDocument::roadRemoved);
    connect(&mUndoRedo, &WorldDocumentUndoRedo::roadCoordsChanged,
            this, &WorldDocument::roadCoordsChanged);
    connect(&mUndoRedo, &WorldDocumentUndoRedo::roadWidthChanged,
            this, &WorldDocument::roadWidthChanged);
    connect(&mUndoRedo, &WorldDocumentUndoRedo::roadTileNameChanged,
            this, &WorldDocument::roadTileNameChanged);
    connect(&mUndoRedo, &WorldDocumentUndoRedo::roadLinesChanged,
            this, &WorldDocument::roadLinesChanged);
